<?php
$url = 'template/canvas1/index3.html';
$test = file_get_contents($url);
$h1 =str_replace("WeDo",$_POST['webName'],str_replace("2ii.me -超炫个人引导页",$_POST['title'],str_replace("https://www.2ii.me",$_POST['web'],$test)));
?>
<!DOCTYPE html>
...
<div class="header shadow">
  ...
  <br />
<center><a href="http://t.2ii.me/template/canvas1/index3.html" target="_blank"><img width="640px" height="365px" src="img/canvasthree.jpg"></a></center><br />
<form action = "zone2.php#id1" method = "post">
  <center>网页标题:<input type="text" placeholder="" class="form-control" name="title" /></center>
  <br />
  <center>网页文字(WeDo):<input type="text" placeholder="" class="form-control" name="webName" /></center>
  <br />
  ...
  <center><a href="http://t.2ii.me/template/canvas1/index3.html" target="_blank"><input type="button" class="btn btn-embossed btn-primary" value="查看演示"/></a>&nbsp;&nbsp;
