...
<div class="header shadow">
  ...
  <br />
<center><a href="http://t.2ii.me/template/love/index.html" target="_blank"><img width="50%" height="50%" src="img/love.jpg"></a></center><br />
<form action = "love.php#id1" method = "post">
  ...
  <br />
  <center>自定义网址(不支持中文):<?php echo $_SERVER['HTTP_HOST'].'/' ?><input type="text" name="www" style="width:100px";/>.html</center>
