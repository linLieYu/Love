<?php
$url = 'template/birthday/index.html';
$test = file_get_contents($url);
$h1 =str_replace("小红",$_POST['birthday'],$test);
?>
<!DOCTYPE html>
...
<title>WeDo在线工具包 (ノ≧∇≦)ノ -生日祝福网生成</title><link rel="icon" href="img/logo.png" type="image/x-icon">
...
<div class="header shadow">
  ...
  <br />
<center><a href="http://t.2ii.me/template/birthday/index.html" target="_blank"><img width="640px" height="365px" src="img/birthday.jpg"></a></center><br />
<form action = "birthday.php#id1" method = "post">
  <center>祝福的名字:<input type="text" placeholder="" class="form-control" name="birthday"/></center>
  <br />
  ...
  <center><a href="http://t.2ii.me/template/birthday/index.html" target="_blank"><input type="button" class="btn btn-embossed btn-primary" value="查看演示"/></a>&nbsp;&nbsp;
