<?php
$url = 'template/nav2/index.html';
$test = file_get_contents($url);
$h1 =str_replace("WeDo",$_POST['h1'],str_replace("远方的海",$_POST['p'],str_replace("https://www.2ii.me",$_POST['net'],str_replace("2ii.me -浅蓝个人引导页",$_POST['title'],str_replace("809099942",$_POST['qq'],str_replace("https://github.com/linLieYu",$_POST['github'],$test))))));
?>
<!DOCTYPE html>
...
<div class="header shadow">
  ...
  <br />
<center><a href="http://t.2ii.me/template/nav2/index.html" target="_blank"><img width="50%" height="50%" src="img/nav2.jpg"></a></center><br />
<form action = "nav2.php#id1" method = "post">
  ...
  <br />
  <center>网页第一行段落:<input type="text" placeholder="" class="form-control" name="p" /></center>
  <br />
  <center>你的网站地址:<input type="text" placeholder="" class="form-control" name="net"/></center>
  <br />
  <center>你的联系QQ(可作为在线联系地址和引导页头像):<input type="text" placeholder="" class="form-control" name="qq"/></center>
  <br />
  <center>你的github地址:<input type="text" placeholder="" class="form-control" name="github"/></center>
  <br />
  <center>你的头像地址(可选,不填则默认使用QQ头像):<input type="text" placeholder="" class="form-control" name="tx"/></center>
  <br />
  ...
  <center><a href="http://t.2ii.me/template/nav2/index.html" target="_blank"><input type="button" class="btn btn-embossed btn-primary" value="查看演示"/></a>&nbsp;&nbsp;
