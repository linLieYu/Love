<?php
$url = 'template/canvas1/index.html';
$test = file_get_contents($url);
$h1 =str_replace("2ii.me",$_POST['h1'],str_replace("BLOG",$_POST['webName'],str_replace("2ii.me -canvas炫酷引导页",$_POST['title'],str_replace("https://www.2ii.me",$_POST['web'],$test))));
?>
<!DOCTYPE html>
...
<title>WeDo在线工具包 (ノ≧∇≦)ノ -超酷个人引导页生成</title><link rel="icon" href="img/logo.png" type="image/x-icon">
...
<div class="header shadow">
  ...
  <br />
<center><a href="http://t.2ii.me/template/canvas1/index.html" target="_blank"><img width="640px" height="365px" src="img/canvasone.jpg"></a></center><br />
<form action = "zone.php#id1" method = "post">
  <center>网页标题:<input type="text" placeholder="" class="form-control" name="title" /></center>
  <br />
  <center>网页第一行文字(h1):<input type="text" placeholder="" class="form-control" name="h1" /></center>
  <br />
  <center>网页第二行文字:<input type="text" placeholder="" class="form-control" name="webName"/></center>
  <br />
  <center>你的网站地址(需加http://):<input type="text" placeholder="" class="form-control" name="web"/></center>
  <br />
