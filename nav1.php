<?php
$url = 'template/nav1/index.html';
$test = file_get_contents($url);
$h1 =str_replace("WeDo",$_POST['h1'],str_replace("梦想的路上少不了质疑和嘲笑",$_POST['p'],str_replace("坚持自己想做的",$_POST['p1'],str_replace("2ii.me -个人引导页",$_POST['title'],str_replace("相信你会成功.",$_POST['p2'],str_replace("https://www.2ii.me",$_POST['net'],str_replace("BLOG",$_POST['anniu'],$test)))))));
?>
<!DOCTYPE html>
...
<div class="header shadow">
  ...
  <br />
<center><a href="http://t.2ii.me/template/nav1/index.html" target="_blank"><img width="50%" height="50%" src="img/nav1.jpg"></a></center><br />
<form action = "nav1.php#id1" method = "post">
  ...
  <br />
  <center>网页第二行段落:<input type="text" placeholder="" class="form-control" name="p1"/></center>
  <br />
  <center>网页第三行段落:<input type="text" placeholder="" class="form-control" name="p2"/></center>
  <br />
  <center>按钮文字:<input type="text" placeholder="" class="form-control" name="anniu"/></center>
  <br />
  ...
  <center><a href="http://t.2ii.me/template/nav1/index.html" target="_blank"><input type="button" class="btn btn-embossed btn-primary" value="查看演示"/></a>&nbsp;&nbsp;
