<?php
$url = 'template/canvas/index.html';
$test = file_get_contents($url);
$h1 =str_replace("WeDo",$_POST['1'],str_replace("Dream",$_POST['2'],str_replace("never",$_POST['3'],str_replace("2ii.me -炫酷粒子效果文字动画特效",$_POST['title'],str_replace("end",$_POST['4'],str_replace("interesting!",$_POST['5'],$test))))));
?>
<!DOCTYPE html>
...
<div class="header shadow">
  ...
  <br />
<center><a href="http://t.2ii.me/template/canvas/index.html" target="_blank"><img width="50%" height="50%" src="img/canvas.jpg"></a></center><br />
<form action = "canvas.php#id1" method = "post">
  <center>网页标题:<input type="text" placeholder="" class="form-control" name="title" /></center>
  <br />
  <center>第一组文字:<input type="text" placeholder="" class="form-control" name="1"/></center>
  <br />
  <center>第二组文字:<input type="text" placeholder="" class="form-control" name="2" /></center>
  <br />
  <center>第三组文字:<input type="text" placeholder="" class="form-control" name="3"/></center>
  <br />
  <center>第四组文字:<input type="text" placeholder="" class="form-control" name="4"/></center>
  <br />
  <center>第五组文字:<input type="text" placeholder="" class="form-control" name="5"/></center>
  <br />
  ...
  <center><a href="http://t.2ii.me/template/canvas/index.html" target="_blank"><input type="button" class="btn btn-embossed btn-primary" value="查看演示"/></a>&nbsp;&nbsp;
