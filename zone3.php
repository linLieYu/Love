<?php
$url = 'template/canvas1/index4.html';
...
<div class="header shadow">
  ...
  <br />
<center><a href="http://t.2ii.me/template/canvas1/index4.html" target="_blank"><img width="640px" height="365px" src="img/canvasfour.jpg"></a></center><br />
<form action = "zone3.php#id1" method = "post">
  ...
  <center><a href="http://t.2ii.me/template/canvas1/index4.html" target="_blank"><input type="button" class="btn btn-embossed btn-primary" value="查看演示"/></a>&nbsp;&nbsp;
