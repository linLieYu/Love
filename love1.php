<?php
$url = 'template/love1/index.html';
$test = file_get_contents($url);
$h1 =str_replace("yourname",$_POST['yourname'],str_replace("yourlove",$_POST['yourlove'],str_replace("表白网自动生成程序-2ii.me",$_POST['title'],$test)));
?>
<!DOCTYPE html>
...
<title>WeDo在线工具包 (ノ≧∇≦)ノ -表白网生成</title><link rel="icon" href="img/logo.png" type="image/x-icon">
...
<div class="header shadow">
  ...
  <br />
<center><a href="http://t.2ii.me/template/love1/index.html" target="_blank"><img width="640px" height="365px" src="img/love1.jpg"></a></center><br />
<form action = "love1.php#id1" method = "post">
  ...
  <center><a href="http://t.2ii.me/template/love1/index.html" target="_blank"><input type="button" class="btn btn-embossed btn-primary" value="查看演示"/></a>&nbsp;&nbsp;
